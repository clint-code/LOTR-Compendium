  ...
  return (
    ...
    <div className="min-h-screen bg-gradient-to-b  text-gray-100">
      ...
      <div className="mx-auto flex max-w-6xl flex-col gap-8 px-4 py-10 lg:px-6">
        ...
        <header className="rounded-3xl border border-[#1f1a2e] p-8 shadow-[0_0_45px_rgba(93,183,255,0.15)] backdrop-blur">
          <p className="text-xl uppercase font-passion tracking-[0.4em] ">
            The One API
          </p>
          <h1 className="mt-4 text-3xl font-passion md:text-4xl">
            Middle-earth Media Compendium
          </h1>
          <p className="mt-3 max-w-3xl font-garamondBold text-lg">
